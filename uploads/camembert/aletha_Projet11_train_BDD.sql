...
--
-- Hôte : localhost
-- Généré le :  lun. 26 nov. 2018 à 16:11
...
--
-- Base de données :  `aletha_Projet11_train_BDD`
--
...
CREATE TABLE `Apprenants` (
  `id` int(11) NOT NULL,
  `Prénom` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `index_deprtmt` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL
...
INSERT INTO `Apprenants` (`id`, `Prénom`, `index_deprtmt`) VALUES
(1, 'Aleth', '1'),
(2, 'Emilie', '2'),
(3, 'Anjum', '1'),
(4, 'Morganne', '3'),
...
CREATE TABLE `Departements` (
  ...
  `dpt-nb` varchar(3) COLLATE utf8mb4_bin NOT NULL,
  `dpt-nm` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
INSERT INTO `Departements` (`Indx`, `dpt-nb`, `dpt-nm`, `id_dep`) VALUES
(1, '90', 'Territoire-de-Belfort', 1),
(2, '70', 'Haute-Saône', 2),
(4, '25', 'Doubs', 3),
(8, '68', 'Haut-Rhin', 4),
(13, '73', 'Savoioubien', 5),
...
CREATE TABLE `TABLE1` (
  ...
  `zip_code` varchar(14) CHARACTER SET utf8 DEFAULT NULL,
  `avatar_url` varchar(84) CHARACTER SET utf8 DEFAULT NULL,
  `state_code` varchar(4) CHARACTER SET utf8 DEFAULT NULL,
